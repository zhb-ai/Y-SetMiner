select 客户编码 ,客户名称 , 市场部,部门,业务员  ,sum(流水)流水
from (
select
ii.fstatus,
ii.vdef20 ,
...
and  ii.dbilldate >=  '2025-01-01') a 
group by 客户编码 ,客户名称 , 市场部,部门,业务员
-- and ib.width in ('兼容')
-- and ib.invname  = '扬帆耐立YFHC CC388A黑鼓(带芯片)-2支装'
-- and cu.custname  = '欧菲思达（北京）科技发展有限公司'
--and  ii.dbilldate between  '2025-01-01' and '2025-08-14'
