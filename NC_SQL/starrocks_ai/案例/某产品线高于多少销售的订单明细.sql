...
yw.businame as 业务类型,
js.vdef11 as 业务属性,
case when (cg.批发售价 > (js.nsummny/js.nnewbalancenum) or  js.blargessflag = 'Y') and cg.invpinpai like '%懿%'  then 1 else 0 end 买赠标记,
...
hl.dbilldate 单据日期,
case when (case when js.dapprovedate is null then js.dmakedate else js.dapprovedate end ) >= to_char(sysdate-91,'yyyy-mm-dd') then (case when js.dapprovedate is null then js.dmakedate else js.dapprovedate end ) else null end 近三月下单日期,   
...
length(cg.invcode) >= 5
and js.dr=0
--  and ((js.dapprovedate between '2023-11-01' and '2023-11-08'or js.dmakedate between '2023-11-08' and '2023-11-08')
and hl.vreceiptcode in (
select 单据号  from (
select 单据号,sum(价税合计)价税合计 from (
select
hl.vreceiptcode  as 单据号,
(CASE WHEN TO_NUMBER(js.nnewbalancenum*js.vbodydef5)=0 OR js.nnewbalancenum*js.vbodydef5 IS NULL THEN js.nsummny  ELSE js.nnewbalancenum*js.vbodydef5 END) AS 价税合计
from nc5x.so_squaredetail js
...
and js.dr=0
-- and ((js.dapprovedate between '2023-11-01' and '2023-11-08'or js.dmakedate between '2023-11-08' and '2023-11-08')
and ((js.dapprovedate between '2022-11-01' and '2022-12-31'or js.dmakedate between '2022-11-01' and '2022-12-31')
or (js.dapprovedate between '2021-11-01' and '2021-12-31'or js.dmakedate between '2021-11-01' and '2021-12-31')
or (js.dapprovedate between '2020-11-01' and '2020-12-31'or js.dmakedate between '2020-11-01' and '2020-12-31')
)
and cg.invpinpai in ('惠普')
and cg.length = '硒鼓')
) group by 单据号) where 价税合计 >= 100000)
